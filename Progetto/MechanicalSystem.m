classdef MechanicalSystem < handle %sistema base su cui si basa il sistema meccanico
    %è vista come una serie di properties dove sono indicati i dati del sistema che poi uso per fare la simulazione
    %molto utili se ho un sistema scritto nello spazio dello stato per
    %evitare di fare gli array
    ...
    methods  (Access = public)
        ...
        function obj=MechanicalSystem(st)% sono i membri che tengo in memoria
            obj.st=st;
            obj.x=zeros(2,1);
            obj.x0=zeros(2,1);
            obj.order=2;
        ...
        %per vedere come evolve il mio sistema
        ...
        % show system printa  a video come è fatto il mio sistema
    ...
    methods  (Access = protected)
        ...
        % ouput=g(x,u) -> considero ance del rumore
